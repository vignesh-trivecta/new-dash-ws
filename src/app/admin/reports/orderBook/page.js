...
const OrderBook = () => {
  ...
  const excelColumns = ["Remote Order ID", "Exchange", "Buy/ Sell", "Exchange Order Time", "Script", "Quantity", "Rate ₹", "Order Status", "Market/ Limit"];
  const pdfColumns = ["Remote Order ID", "Exchange", "Buy/ Sell", "Exchange Order Time", "Script", "Quantity", "Rate", "Order Status", "Market/ Limit"];
