      ...
      <div className="flex flex-col space-y-20">
        ...
        <div className="p-2">
          ...
          <div className="flex justify-center space-x-10 text-sm md:text-base">
            <div className="">
              ...
              <input
                ...
                className="w-20 sm:w-32 border-gray-200 bg-gray-50 rounded-md text-right"
              />
            </div>
            <div className="">
              <p>Basket Type</p>
              <input
                ...
                className="w-20 sm:w-32 border-gray-200 bg-gray-50 rounded-md text-center"
              />
            </div>
            <div className="">
              <p>Basket Value &#8377;</p>
              <input
                disabled
                type="text"
                value={segregate(basketValue.toFixed(2))}
                className="w-20 sm:w-32 border-gray-200 bg-gray-50 rounded-md text-right"
              />
            </div>
          </div>
          ...
          <div className="flex justify-center space-x-4 mt-4">
            ...
            <Button color="gray" disabled={disableButton}>
              Decline
            </Button>
          </div>
