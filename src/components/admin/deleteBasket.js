  ...
  return (
    <div>
        <Link href="#" onClick={handleDelete}>
            <svg className="w-4 h-4 text-gray-500 hover:text-red-500 hover:fill-red-500 dark:text-white" ariaHidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 20 18">
