...
export default function MapAlert({ popup, setPopup, saved, setSaved }) {
                    ...
                    <div className="mt-3 text-center sm:ml-4 sm:mt-0 sm:text-left">
                      ...
                      <div className="mt-2">
                        <p className="text-sm text-gray-700">
                          Do you want to map this basket to a customer?
                        </p>
                      </div>
                    </div>
                  </div>
                </div>
                <div className="bg-gray-50 px-4 py-3 sm:flex justify-center sm:px-6 space-x-4">
                  <button
                    type="button"
