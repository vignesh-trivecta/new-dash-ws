...
export const { setRecId, setSelectedStock, setInstrumentName, setExchange, setTransType, setOrderType, setWeightage, setQuantity, setPrice } = updateRecordSlice.actions;
